  ...
  return (
    ...
    min-h-screen gap-10 max-container">
      ...
      max-xl:padding-x pt-36">
        ...
        <Button label="Shop New" iconURL={arrowRight} />
      ...
      max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        <img src={bigShoeImg} alt="Shoe Collaction" width={610} height={500}
        className="object-contain relative z-10">
        </img>
        

        <div className="flex sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[10p%] max-sm:px-6">
          {shoes.map((shoe)=>(
            <div key={shoe}>
              <ShoeCard
                imgURL={shoe} changeBigShoeImage={(shoe)=>{
                  setbigShoeImg(shoe)
